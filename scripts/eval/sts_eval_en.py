...
실행 예:
  uv run python scripts/eval/sts_eval_en.py model=bge_large_en
  uv run python scripts/eval/sts_eval_en.py model=mxbai_large
  uv run python scripts/eval/sts_eval_en.py model=bge_base_en
  uv run python scripts/eval/sts_eval_en.py model=mpnet_base
  uv run python scripts/eval/sts_eval_en.py model=bge_m3
"""
